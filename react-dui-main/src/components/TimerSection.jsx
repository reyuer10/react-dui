...
function TimerSection() {
  return (
    <div className="w-[350px] ring-8 ring-black font-rubik flex items-center justify-around mx-2 my-6 from-yellow-300 via-yellow-400 to-orange-400 bg-gradient-to-bl border-[7px] border-yellow-300  shadow-inner shadow-orange-700 rounded-xl py-2">
      <div className="">
        <div>
