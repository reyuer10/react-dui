      ...
      <div>
        {rd.colorResults.map((colors, index) => {
          return (
            ...
            >
              <div
                className={`bg-gray-300 relative flex justify-center items-center shadow-black ring-2 ring-black shadow-lg h-[80px] w-[80px] rounded-[22px]`}
              >
                {rd.timesThree ? (
                  <>
              ...
              <div
                className={`flex justify-center items-center bg-gray-300 shadow-black ring-2 ring-black shadow-lg h-[80px] w-[80px] rounded-[22px]`}
              >
                <div
              ...
              <div
                className={`bg-gray-300 flex items-center justify-center shadow-black ring-2 ring-black shadow-lg h-[80px] w-[80px] rounded-[22px]`}
              >
                <div
